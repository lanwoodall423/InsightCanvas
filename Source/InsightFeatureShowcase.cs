    ...
    public static class InsightFeatureShowcase
    {
        ...
        private sealed class FeatureShowcaseDocument
        {
            ...
            private InsightUiElement BuildRoot()
            {
                ...
                InsightUiStack root = InsightUi.Column("showcase-root").SetGap(8f) as InsightUiStack;
                root.SetPadding(10f);
                root.Add(BuildHeader(), navigation.SetFlex(1f));
                return root;
            }

            private InsightUiElement BuildHeader()
            {
                InsightUiStack header = InsightUi.Row("showcase-header").SetGap(10f) as InsightUiStack;
                ...
                InsightUiStack titleBlock = InsightUi.Column("showcase-title-block").SetGap(1f) as InsightUiStack;
            ...
            {
                InsightUiStack body = InsightUi.Column(id + ".body").SetGap(10f) as InsightUiStack;
            ...
            {
                InsightUiStack column = InsightUi.Column("overview-content").SetGap(10f) as InsightUiStack;
                InsightUiStack hero = InsightUi.Column("overview-hero").SetGap(8f) as InsightUiStack;
                ...
                column.Add(Card("overview-hero-card", hero));
                ...
                InsightUiStack actions = InsightUi.Row("overview-actions").SetGap(8f) as InsightUiStack;
            ...
            {
                InsightUiStack column = InsightUi.Column("foundations-content").SetGap(10f) as InsightUiStack;
                ...
                InsightUiStack type = InsightUi.Column("foundations-type").SetGap(4f) as InsightUiStack;
            ...
            {
                InsightUiStack column = InsightUi.Column("layout-content").SetGap(10f) as InsightUiStack;
                ...
                column.Add(InsightUi.Label("layout-adaptive-title", "Adaptive grid", InsightUiTextStyle.Heading), adaptive,
                    InsightUi.Label("layout-split-title", "Split pane with scrolling", InsightUiTextStyle.Heading), split);
                return column;
            }

            private InsightUiElement BuildControls()
            {
                InsightUiStack column = InsightUi.Column("controls-content").SetGap(10f) as InsightUiStack;
                ...
                InsightUiStack settings = InsightUi.Column("controls-settings").SetGap(7f) as InsightUiStack;
                settings.Add(highContrast, reducedMotion, selector, textField, interactionStatus);
                ...
                InsightUiStack actions = InsightUi.Column("controls-actions").SetGap(7f) as InsightUiStack;
            ...
            {
                InsightUiStack column = InsightUi.Column("workspaces-content").SetGap(10f) as InsightUiStack;
                ...
                InsightUiStack toolbar = InsightUi.Row("workspace-toolbar").SetGap(7f) as InsightUiStack;
            ...
            {
                InsightUiStack column = InsightUi.Column("data-content").SetGap(10f) as InsightUiStack;
                InsightUiTextField search = InsightUi.TextField("data-search", string.Empty, ApplyFilter);
                search.SetTooltip("Filter deterministic records by name, group, or tag");
                InsightUiStack searchRow = InsightUi.Row("data-search-row").SetGap(8f) as InsightUiStack;
            ...
            {
                InsightUiStack column = InsightUi.Column("motion-content").SetGap(10f) as InsightUiStack;
                ...
                column.Add(Card("motion-demo-card", InsightUi.Column("motion-demo-body").SetGap(8f).Add(
                    InsightUi.Label("motion-demo-title", "Feedback without noise", InsightUiTextStyle.Heading), motionStatus, motionProgress,
            ...
            {
                InsightUiStack column = InsightUi.Column("themes-content").SetGap(10f) as InsightUiStack;
                ...
                InsightUiStack themeButtons = InsightUi.Row("themes-buttons").SetGap(7f) as InsightUiStack;
            ...
            {
                InsightUiStack column = InsightUi.Column("advanced-content").SetGap(10f) as InsightUiStack;
                ...
                InsightUiStack optional = InsightUi.Column("advanced-optional-stack").SetGap(8f) as InsightUiStack;
            ...
            {
                InsightUiStack column = InsightUi.Column("diagnostics-content").SetGap(8f) as InsightUiStack;
                ...
                InsightUiStack metrics = InsightUi.Column("diagnostics-metrics").SetGap(6f) as InsightUiStack;
                metrics.Add(summary, theme, responsive, selected, errors,
            ...
            {
                InsightUiStack table = InsightUi.Column("data-metrics-table").SetGap(4f) as InsightUiStack;
                string[] labels = { "Population", "Confidence", "Momentum", "Coverage", "Risk" };
                for (int i = 0; i < labels.Length; i++)
                {
                    InsightUiStack row = InsightUi.Row("data-metric-row-" + i).SetGap(8f) as InsightUiStack;
            ...
            private InsightUiElement CreateRecordRow(int filteredIndex)
            {
                ...
                InsightUiStack row = InsightUi.Row("data-record-row-" + record.Id).SetGap(7f) as InsightUiStack;
            ...
            {
                InsightUiStack items = InsightUi.Column(id + "-items").SetGap(5f) as InsightUiStack;
